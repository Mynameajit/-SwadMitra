...
import { ArrowBack, Business, Fastfood, Home, Restaurant, Save } from '@mui/icons-material'
...
const ShippingDetails = () => {
  ...
  const handleAddAddress = async () => {
    ...
    try {
      ...
      const res = await axios.post(`${backendURL}/user/address/add`, formData, {
    ...
    <Stack minHeight={"100vh"} width={"100%"} justifyContent={"center"} alignItems={"center"}>
      ...
      >
        ...
        <MotionIconButton
          ...
          onClick={() => Navigate(-1)}
        >
          <ArrowBack sx={{ fontSize: "3rem,", color: "#FF1100" }} />
        </MotionIconButton>
        ...
        <MotionLogo
          ...
          <Typography sx={{ fontWeight: "700", color: "#FF1100" }}
            textAlign={"center"} variant='h5'>Shipping Address</Typography>

        </MotionLogo>

        <Stack gap={1.8} direction={"column"} width={"100%"} alignItems={"center"}>
          ...
          <Stack mt={2} width={"100%"} gap={1} sx={{}}>
            ...
            >
              ...
              }
              {
                ...
                </Typography> : "Add Shipping Address"
              }
            </MotionSaveButton>
          </Stack>
